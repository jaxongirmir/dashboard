...
export const mockdata = [
	...
	// },
	{
		...
		links: [
			...
			{ label: 'Vakantlar', link: '/vakantlar' },
	...
	},
	{
		...
		icon: Icon3dCubeSphere,
		links: [
			{ label: 'Mutaxassisliklar', link: '/mutaxassisliklar' },
			{ label: 'Talabalar bazasi', link: '/talabalar-bazasi' },
			{ label: 'Akademik guruhlar', link: '/akademik-guruhlar' },
			{ label: 'Talabani biriktirish', link: '/talabalar' },
			{ label: "Talabalar ro'yxati", link: '/talabalar-royxati' },
			{ label: 'Qabul kvotasi', link: '/qabul-kvotasi' },
			{ label: "Talaba yutug'i", link: '/talaba-yutugi' },
			{ label: 'Kvalifikatsiyalar', link: '/kvalifikatsiyalar' },
			{ label: 'Talaba almashinuv', link: '/talaba-almashinuv' },
			{ label: "Musobaqa g'olibi", link: '/musobaqa-golibi' },
			{ label: 'Sport klublari', link: '/sport-klublari' },
		],
	},
]
